...
// Helper function to check for unsafe property names that could lead to prototype pollution
...
module.exports = function onValue(model, node, seed, depth, outerResults,
    ...
    if (isJSONG) {
        ...
        for (i = 0, len = optimizedLength - 1; i < len; i++) {
            ...
            // Skip unsafe property names that could lead to prototype pollution
